...
return new class extends Migration
{
    ...
    {
        Schema::create('summary_attribution_daily', function (Blueprint $table) {
            ...
            $table->primary(['workspace_id', 'summary_date', 'model']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('summary_attribution_daily');
    }
};
