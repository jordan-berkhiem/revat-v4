...
return new class extends Migration
{
    ...
    {
        Schema::create('summary_campaign_by_platform', function (Blueprint $table) {
            ...
            $table->primary(['workspace_id', 'platform', 'summary_date']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('summary_campaign_by_platform');
    }
};
